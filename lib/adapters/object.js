 ...
 * @return {string} id;
 */
var defaultIdGenerator = function defaultIdGenerator(index, link) {
  return "" + index;
};
...
var ObjectGraph = function (_AncientGraph) {
   ...
   */
  function ObjectGraph(collection, fields, idGenerator) {
    ...
    _this.fields = fields;
    _this.idGenerator = idGenerator ? idGenerator : defaultIdGenerator;
