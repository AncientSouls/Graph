...
function factoryGraph(ParentClass) {
  ...
  var Graph = function (_ParentClass) {
    _inherits(Graph, _ParentClass);
     ...
     */
    function Graph(collection, fields, config) {
      _classCallCheck(this, Graph);

      var _this = _possibleConstructorReturn(this, (Graph.__proto__ || Object.getPrototypeOf(Graph)).apply(this, arguments));

      _this.collection = collection;
      _this.fields = fields;
      _this.config = config;
      if (_this.insert == Graph.prototype.insert) {
        throw new Error('Method `insert` is not adapted.');
      }
      if (_this.update == Graph.prototype.update) {
        throw new Error('Method `update` is not adapted.');
      }
      if (_this.remove == Graph.prototype.remove) {
        throw new Error('Method `remove` is not adapted.');
      }
      if (_this.query == Graph.prototype.query) {
        throw new Error('Method `query` is not adapted.');
      }
      if (_this.options == Graph.prototype.options) {
        throw new Error('Method `options` is not adapted.');
      }
      if (_this.fetch == Graph.prototype.fetch) {
        throw new Error('Method `fetch` is not adapted.');
      }
      if (_this.get == Graph.prototype.get) {
        throw new Error('Method `get` is not adapted.');
      }
      if (_this.each == Graph.prototype.each) {
        throw new Error('Method `each` is not adapted.');
      }
      if (_this.map == Graph.prototype.map) {
        throw new Error('Method `map` is not adapted.');
      }
      if (_this.count == Graph.prototype.count) {
        throw new Error('Method `count` is not adapted.');
      }
      if (_this.on == Graph.prototype.on) {
